...
<head>
    <meta charset="utf-8" />
    <title>天地物流有限公司 - 用户中心 - 开通钱包</title>
...
<div class="sec aboutpg container">
    ...
    <form action="${ctx}/property/openWallet" method="post">
    <div class="col-sm-9 introduce">
        ...
        <div class="contact con-pad">
            <div class="address">
                <p>交易密码：<input type="password" id="newTransactionPassword"/></p>
                <p>确认密码：<input type="password" id="reTransactionPassword" name="ppwd" onchange="isTransactionPassword()" /></p>
                <input type="submit" value="开通" style="background-color: #b11e22; font-size: 12px; color: #fff; width: 86px; height: 37px; border: none; cursor: pointer; border: 0px;text-align: center;" />
            </div>
        </div>
    </div>
    </form>
