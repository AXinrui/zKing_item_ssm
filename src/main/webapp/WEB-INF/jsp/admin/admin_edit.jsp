...
<div class="layui-fluid">
    <div class="layui-row">
        <form class="layui-form" action="/admin/editAdmin" method="post" >
            <div class="layui-form-item" >
                <input type="hidden" name="aid" value="${sessionScope.admin.aid}" >
                <label for="L_email" class="layui-form-label">
                    <span class="x-red">*</span>账号：</label>
                <div class="layui-input-inline">
                    <input type="text" id="account" name="account"  value="${sessionScope.admin.account}" required=""  autocomplete="off" class="layui-input"></div>
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input type="text" id="pwd" name="ypwd" required="" autocomplete="off" class="layui-input"></div>
            </div>
            <div class="layui-form-item">
            ...
            <div class="layui-form-item">
                <label for="L_repass" class="layui-form-label">
                    <span class="x-red">*</span>绑定邮箱</label>
                <div class="layui-input-inline">
                    <input type="text" id="email"  lay-verify="email" name="email" value="${sessionScope.admin.email}" required=""  autocomplete="off" class="layui-input"></div>
            </div>
            <div class="layui-form-item">
