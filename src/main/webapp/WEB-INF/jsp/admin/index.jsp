...
<div class="container">
    ...
    <ul class="layui-nav right" lay-filter="">
        <li class="layui-nav-item">
            <a href="javascript:;">${sessionScope.admin.account}</a>
            <dl class="layui-nav-child">
                <!-- 二级菜单 -->
                <dd>
        ...
        <ul id="nav">
            <li>
                ...
                <ul class="sub-menu">
                    ...
                    <li>
                        <a onclick="xadmin.add_tab('用户列表','${ctx}/user/userList')">
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>用户列表</cite></a>
                    </li>
                    <li>
            ...
            <li>
                ...
                <ul class="sub-menu">
                    <li>
                        <a onclick="xadmin.add_tab('公司地图设置','${ctx}/url/admin/mapList')">
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>公司地图设置</cite></a>
                    </li>
                    <li>
                        <a onclick="xadmin.add_tab('地图位置获取','${ctx}/url/admin/doGetMap')">
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>地图位置获取</cite></a>
                    </li>
                    <li>
    ...
    <div class="layui-tab tab" lay-filter="xbs_tab" lay-allowclose="false">
        ...
        <div class="layui-tab-content">
            <div class="layui-tab-item layui-show">
                <iframe src='${ctx}/url/admin/doWelcome' frameborder="0" scrolling="yes" class="x-iframe"></iframe>
            </div>
        </div>
        <div id="tab_show"></div>
    </div>
