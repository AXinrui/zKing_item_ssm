...
<script type="text/javascript">
    ...
    map.centerAndZoom(new BMap.Point(112.897994,28.198974), 17);  // 初始化地图,设置中心点坐标和地图级别
    map.enableScrollWheelZoom(true);     //开启鼠标滚轮缩放
    var point = new BMap.Point(${mapVo.x},${mapVo.y});
    ...
    var opts = {
        width : 200,     // 信息窗口宽度
        height: 80,     // 信息窗口高度
        title : "${mapVo.title}" , // 信息窗口标题
    }
    var infoWindow = new BMap.InfoWindow("${mapVo.content}", opts);  // 创建信息窗口对象
