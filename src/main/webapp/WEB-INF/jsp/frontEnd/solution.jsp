    ...
    <div class="col-sm-9 introduce">
        ...
        <div class="contact con-pad">
            <div id="message" class="row">
                <form action="${ctx}/message/solution" method="post">
                    <div class="col-sm-6">
                        <p>姓名：</p>
                        <input type="text" placeholder="姓名" name="mname" />
                    </div>
                    <div class="col-sm-6">
                        <p>联系电话：</p>
                        <input type="tel" placeholder="电话号码" name="mphone" />
                    </div>
                    <div class="col-xs-12">
                        <p>发送的消息：</p>
                        <textarea placeholder="消息" name="mcontent"></textarea>
                        <input type="submit" value="立即发送" style="margin-top: 10px;" />
                    </div>
                </form>
            </div>
        </div>
