            ...
            <div class="col-sm-5">
                ...
                <div class="service square-title">
                    ...
                    <ul class="clearfix">
                        <li>
                            <a href="service.html">
                                <img src="${ctx}/static/images/serli/2.png" />
                                <span>物流卡航</span>
                            </a>
                        </li>
                        <li>
                            <a href="service1.html">
                                <img src="${ctx}/static/images/serli/6.png" />
                                <span>物流空运</span>
                            </a>
                        </li>
                        <li>
                            <a href="service2.html">
                                <img src="${ctx}/static/images/serli/5.png" />
                                <span>限时到达</span>
                            </a>
                        </li>
                        <li>
                            <a href="service3.html">
                                <img src="${ctx}/static/images/serli/4.png" />
                                <span>物流普运</span>
                            </a>
                        </li>
                        <li>
                            <a href="service4.html">
                                <img src="${ctx}/static/images/serli/3.png" />
                                <span>城际快线</span>
                            </a>
                        </li>
                        <li>
                            <a href="service5.html">
                                <img src="${ctx}/static/images/serli/1.png" />
                                <span>合作共赢</span>
                            </a>
                        </li>
                    </ul>
